...
SRC_DIR="${ROOT_DIR}/sources/mylittleforum"
...
MYLITTLEFORUM_IMAGE_TAG="${MYLITTLEFORUM_IMAGE_TAG:-mylittleforum-2.5.11}"
...
echo "==> Build mylittleforum image from source Dockerfile"
docker build \
...
echo "==> Push mylittleforum image to ACR"
...
echo "==> Done"
echo "mylittleforum image: ${APP_IMAGE}"
