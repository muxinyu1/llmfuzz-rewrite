...
class TorrentPierVerifier(Verifier, BaseModel):

    # Port used for callback requests from the target environment.
    ...
    def build(
        ...
        if ground_truth is None:
            ground_truth = ["torrentpier0"]

        torrentpier = TorrentPierVerifier(
